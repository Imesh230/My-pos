                        ...
                        <div class="col">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-3">
                                        <label for="barcode" class="form-label">Barcode (Optional - Auto-generated if empty)</label>
                                        <input type="text" name="barcode" class="form-control @error('barcode') is-invalid @enderror" id="barcode" placeholder="Enter barcode or leave empty for auto-generation..." value="{{old('barcode')}}">
                                        @error('barcode')
                                            <small class="invalid-feedback">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Sell Price (Rs)</label>
                                        <input type="text" name="price"
                                            class="form-control @error('price') is-invalid @enderror"
                                            id="exampleFormControlInput1" placeholder="Price in Rs..." value="{{old('price')}}">
                                        @error('price')
                                            <small class="invalid-feedback">{{ $message }}</small>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Purchase Price (Rs)</label>
                                        <input type="text" name="purchaseprice"
                                            class="form-control @error('purchaseprice') is-invalid @enderror"
                                            id="exampleFormControlInput1" placeholder="Purchase price in Rs..." value="{{old('purchaseprice')}}">
                                        @error('purchaseprice')
                                            <small class="invalid-feedback">{{ $message }}</small>
                                        @enderror
                                    </div>
