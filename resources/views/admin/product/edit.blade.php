                            ...
                            <div class="col">
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="barcode" class="form-control @error('barcode') is-invalid @enderror" id="barcode" placeholder="Enter barcode..." value="{{old('barcode',$products->barcode)}}">
                                        @error('barcode')
                                            <small class="invalid-feedback">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="price"
                                                ...
                                                id="exampleFormControlInput1" placeholder="Price in Rs..." value="{{old('price',$products->price)}}">
                                            @error('price')
                                                <small class="invalid-feedback">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="col">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="purchaseprice"
                                                ...
                                                id="exampleFormControlInput1" placeholder="Purchase price in Rs..." value="{{old('purchase_price',$products->purchase_price)}}">
