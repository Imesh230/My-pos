...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Repair Service</h1>
        <div>
            <a href="{{ route('repair.show', $repair) }}" class="btn btn-info">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Repair Service Information</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('repair.update', $repair) }}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('customer_name') is-invalid @enderror" 
                                   id="customer_name" name="customer_name" value="{{ old('customer_name', $repair->customer_name) }}" required>
                            @error('customer_name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('customer_phone') is-invalid @enderror" 
                                   id="customer_phone" name="customer_phone" value="{{ old('customer_phone', $repair->customer_phone) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('customer_email') is-invalid @enderror" 
                                   id="customer_email" name="customer_email" value="{{ old('customer_email', $repair->customer_email) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('device_brand') is-invalid @enderror" 
                                ...
                                <option value="Samsung" {{ old('device_brand', $repair->device_brand) == 'Samsung' ? 'selected' : '' }}>Samsung</option>
                                <option value="Apple" {{ old('device_brand', $repair->device_brand) == 'Apple' ? 'selected' : '' }}>Apple</option>
                                <option value="Huawei" {{ old('device_brand', $repair->device_brand) == 'Huawei' ? 'selected' : '' }}>Huawei</option>
                                <option value="Oppo" {{ old('device_brand', $repair->device_brand) == 'Oppo' ? 'selected' : '' }}>Oppo</option>
                                <option value="Vivo" {{ old('device_brand', $repair->device_brand) == 'Vivo' ? 'selected' : '' }}>Vivo</option>
                                <option value="Xiaomi" {{ old('device_brand', $repair->device_brand) == 'Xiaomi' ? 'selected' : '' }}>Xiaomi</option>
                                <option value="OnePlus" {{ old('device_brand', $repair->device_brand) == 'OnePlus' ? 'selected' : '' }}>OnePlus</option>
                                <option value="Other" {{ old('device_brand', $repair->device_brand) == 'Other' ? 'selected' : '' }}>Other</option>
                            </select>
                            @error('device_brand')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('device_model') is-invalid @enderror" 
                                   id="device_model" name="device_model" value="{{ old('device_model', $repair->device_model) }}" required>
                            @error('device_model')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('device_imei') is-invalid @enderror" 
                                   id="device_imei" name="device_imei" value="{{ old('device_imei', $repair->device_imei) }}">
                            @error('device_imei')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('repair_notes') is-invalid @enderror" 
                                      id="repair_notes" name="repair_notes" rows="3">{{ old('repair_notes', $repair->repair_notes) }}</textarea>
                            @error('repair_notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" 
                                ...
                                <option value="diagnosed" {{ old('status', $repair->status) == 'diagnosed' ? 'selected' : '' }}>Diagnosed</option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('completed_date') is-invalid @enderror" 
                                   ...
                                   value="{{ old('completed_date', $repair->completed_date ? $repair->completed_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('delivered_date') is-invalid @enderror" 
                                   id="delivered_date" name="delivered_date" 
                                   value="{{ old('delivered_date', $repair->delivered_date ? $repair->delivered_date->format('Y-m-d') : '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('technician') is-invalid @enderror" 
                                   id="technician" name="technician" value="{{ old('technician', $repair->technician) }}">
                            @error('technician')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('warranty_info') is-invalid @enderror" 
                                      id="warranty_info" name="warranty_info" rows="2">{{ old('warranty_info', $repair->warranty_info) }}</textarea>
                            @error('warranty_info')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-group text-center mt-4">
                    <button type="submit" class="btn btn-primary btn-lg">
                        <i class="fas fa-save"></i> Update Repair Service
                    </button>
                    <a href="{{ route('repair.show', $repair) }}" class="btn btn-secondary btn-lg ml-2">
